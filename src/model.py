...
################################################################################
# Our Backbone uses first three block of ResNet-18.
# Rather than starting from scratch we see that using ImageNet pretraining helps a bit.
class Backbone(nn.Module):
	...
	def forward(self, x, mask):
		...
		# Instead of Global average pooling we instead pool by mask.
...
################################################################################
# Constastive loss for SimCLR
# see: https://github.com/cpphoo/STARTUP for more details
...
################################################################################
# Projection layer for projector_SIMCLR loss
...
# Our model for training and testing
class Model(nn.Module):
	...
	# for training it takes a pair of (vt, vt+1, mask_t ) tuples forward passes them throug backbone and projectors to produce z1 and z2
	...
	# for inference one tuple is needed to get its features.
